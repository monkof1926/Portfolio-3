...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        A_StarFormView StarView = new A_StarFormView(GraphModel);
        Controller controller = new Controller(GraphModel, StarView);
        primaryStage.setTitle("AStar Form");
        primaryStage.setScene(new Scene(StarView.asParent(), 400, 300));
        primaryStage.show();
    }
